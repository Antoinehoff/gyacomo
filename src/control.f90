SUBROUTINE control
  ...
  USE time_integration, ONLY: cfl_adjust_dt
  IMPLICIT NONE
  ...
  DO
    ...
    ! Adjust time step based on CFL condition (if enabled)
    ! This is done after the step is completed to use the updated phi field
    CALL cfl_adjust_dt
